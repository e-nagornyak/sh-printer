document.addEventListener('DOMContentLoaded', function () {
  const settingsButton = document.getElementById('settingsButton'); // Кнопка для переходу на сторінку налаштувань

  // Перенаправляємо на сторінку налаштувань
  settingsButton.addEventListener('click', function () {
    window.location.href = 'settings/index.html'; // Відкриваємо сторінку налаштувань
  });
});
